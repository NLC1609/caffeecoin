...
{
    const char* pszTimestamp = "WHOAH so that's Caffee!";
    const CScript genesisOutputScript = CScript() << ParseHex("160984710fa689ad5023690c80f3a49c8f13f8d45b8c857fbcbc8bc4a8e4d3eb4b10f4d4604fa08dce601aaf0f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
...
public:
    CMainParams() {
        strNetworkID = "main";
        consensus.nSubsidyHalvingInterval = 3153600000;
        ...
        genesis = CreateGenesisBlock(1631712602, 2000407961, 0x1e0ffff0, 1, 3000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x31fd4800fdd910e27a03fd674d1f28f6965dbb719b93741d56572afd5d78352c"));
        assert(genesis.hashMerkleRoot == uint256S("0x855aa174cae41dc4e0293d0e89fe0f81f5a519686e065e5bbd3ba749c1152ae9"));

        // Note that of those with the service bits flag, most only support a subset of possible options
        vSeeds.push_back(CDNSSeedData("192.168.1.104:6333", "192.168.1.104:6333", true));
        ...
        checkpointData = (CCheckpointData) {
            ...
            (  0, uint256S("0x31fd4800fdd910e27a03fd674d1f28f6965dbb719b93741d56572afd5d78352c"))
        ...
        chainTxData = ChainTxData{
            ...
            1631712602, // * UNIX timestamp of last known number of transactions
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1631712602, 2317198, 0x1e0ffff0, 1, 3000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xb052b3aca35696b151959e96bf20bb8d7d32673735dbe24857d16b0f2751ce3e"));
        assert(genesis.hashMerkleRoot == uint256S("0x855aa174cae41dc4e0293d0e89fe0f81f5a519686e065e5bbd3ba749c1152ae9"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.push_back(CDNSSeedData("118.200.8.69:6333", "118.200.8.69:6333"));
        //vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.caffeecoin.loshan.co.uk", true));
        ...
        checkpointData = (CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0xb052b3aca35696b151959e96bf20bb8d7d32673735dbe24857d16b0f2751ce3e")),
        };
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1631712602, 0, 0x207fffff, 1, 3000 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x65f53ff7056d44658aeaf75ccebaad6ecaab632ce5c3ba844b0643878c9e9160"));
        assert(genesis.hashMerkleRoot == uint256S("0x855aa174cae41dc4e0293d0e89fe0f81f5a519686e065e5bbd3ba749c1152ae9"));
        ...
        checkpointData = (CCheckpointData){
            boost::assign::map_list_of
            ( 0, uint256S("0x65f53ff7056d44658aeaf75ccebaad6ecaab632ce5c3ba844b0643878c9e9160"))
        };
