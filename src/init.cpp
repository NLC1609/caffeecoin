...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/caffeecoin-project/caffeecoin>";
    const std::string URL_WEBSITE = "<https://caffeecoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Caffeecoin version %s\n", FormatFullVersion());
}
