...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s caffeecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  caffeecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded caffeecoin transaction") + "\n" +
              "  caffeecoin-tx [options] -create [commands]   " + _("Create hex-encoded caffeecoin transaction") + "\n" +
              "\n";
